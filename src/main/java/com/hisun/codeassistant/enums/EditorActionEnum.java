...
public enum EditorActionEnum {
    ...
    FIX_THIS("代码修复", "Fix This in the following code",
    ...
    REVIEW_CODE("代码审查", "Review code in the following code",
    ...
    EXPLAIN_THIS("解释代码", "Explain this in the following code",
