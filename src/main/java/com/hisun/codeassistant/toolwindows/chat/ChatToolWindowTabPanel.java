...
import com.hisun.codeassistant.toolwindows.chat.ui.textarea.TotalTokensDetails;
...
public abstract class ChatToolWindowTabPanel implements Disposable {
    ...
    private void call(
        ...
        var requestHandler = new CompletionRequestHandler(new ToolWindowCompletionResponseEventListener(
                conversationService,
                responsePanel,
                totalTokensPanel,
                userPromptTextArea) {
