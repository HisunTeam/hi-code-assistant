    ...
    static class Header extends JPanel {
        ...
        public void addReloadAction(Runnable onReload) {
            addIconActionButton(new IconActionButton(
                    new AnAction(
                            HiCodeAssistantBundle.get("toolwindow.chat.response.action.reloadResponse.text"),
                            HiCodeAssistantBundle.get("toolwindow.chat.response.action.reloadResponse.description"),
        ...
        public void addDeleteAction(Runnable onDelete) {
            addIconActionButton(new IconActionButton(
                    new AnAction(
                            HiCodeAssistantBundle.get("toolwindow.chat.response.action.deleteResponse.text"),
                            HiCodeAssistantBundle.get("toolwindow.chat.response.action.deleteResponse.description"),
                            AllIcons.Actions.GC) {
                        @Override
                        public void actionPerformed(@NotNull AnActionEvent e) {
                            onDelete.run();
