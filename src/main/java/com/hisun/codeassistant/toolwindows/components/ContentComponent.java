...
import com.hisun.codeassistant.toolwindows.components.code.CodeHeaderComponent;
import com.hisun.codeassistant.toolwindows.components.code.GoToCode;
...
public class ContentComponent extends JPanel {
    ...
    public JPanel createRightActionComponent(String labelText, Project project, EditorInfo editorInfo) {
        ...
        selectedCodeJumpPane.add(new JBLabel("引用："));
